...
/**
 * A Spring User bridges the Traccar User to Spring Security and supplies
 * authentication states live.
 * <p>
 * see www.traccar.org/documentation/user-management/
 */
...
//	"ROLE_" strings should not be used externally
	public final static String traccarAdmin = "ROLE_ADMIN";
	public final static String traccarManager = "ROLE_MANAGER";
	public final static String traccarUser = "ROLE_USER";

	/**
	 * Retrieve User from Spring Security and use as key to access role based
	 * methods.
	 */
	...
	/**
	 * Method for completeness. Only makes sense to distinguish user from
	 * unregistered user on unprotected pages. Otherwise every unauthorized method
	 * can be accessed by a normal user.
	 */
