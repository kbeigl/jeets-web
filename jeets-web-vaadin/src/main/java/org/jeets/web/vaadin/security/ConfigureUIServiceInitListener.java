 ...
 * the path does change. To secure a Vaadin application, we need to wire Spring
...
public class ConfigureUIServiceInitListener implements VaadinServiceInitListener {
	...
	/**
	 * Listen for the initialization of the UI (the internal root component in
	 * Vaadin) and then add a listener before every view transition.
	 */
	@Override
